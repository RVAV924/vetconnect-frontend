...
// ============================================================
// PAGE 1 — "Check your email" waiting screen.
// Show this immediately after the user signs up.
// The backend sends a verification link to their email.
// User clicks the link → backend verifies → redirects to
// /verify-success (Page 2 — VerificationSuccess.jsx)
//
// Props:
//   email (string) — optional, pass the registered email
//                    so it shows "We sent a link to abc@..."
// ============================================================

const BACKEND_RESEND_URL = 'http://localhost:5000/resend-verification';
...
const EmailVerification = ({ email = '' }) => {
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await fetch(BACKEND_RESEND_URL, {
        method: 'POST',
