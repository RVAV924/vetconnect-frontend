...
// ============================================================
// PAGE 2 — Verification result screen.
// The backend redirects here after the user clicks the
// link in their email: e.g. GET /verify/:token on backend
// → on success, backend redirects to:
//   http://localhost:5173/verify-success?status=ok
//   or on failure:
//   http://localhost:5173/verify-success?status=error&msg=...
//
// Tell your backend dev to redirect to this URL format:
//   /verify-success?status=ok
//   /verify-success?status=error&msg=Token+expired
//   /verify-success?status=already
// ============================================================

const VerificationSuccess = () => {
  const navigate = useNavigate();

  // Read ?status= and ?msg= from the URL query params
